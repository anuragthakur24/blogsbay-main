            ...
            <motion.div
              ...
              <div className="space-y-5 mt-5">
                ...
                <div>
                  ...
                  <input id="username" type="text" name="username" value={formData.username} onChange={handleChange} autoComplete="off" placeholder="Enter your username" className="w-full px-4 py-3 bg-[#1e293b] text-white rounded-lg focus:outline-none" />
                </div>
