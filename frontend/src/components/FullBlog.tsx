                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex items-center mt-2">
                                ...
                                <span className="text-base font-bold pl-2">{blog.author.name}</span>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="flex space-x-4 w-full sm:w-auto justify-center sm:justify-start">
                                <button onClick={toggleLike} disabled={isButtonDisabled}
                                    className={`w-full sm:w-auto bg-indigo-900 ${isProcessingLike ? "opacity-50 cursor-not-allowed" : "hover:bg-indigo-950"} text-white font-semibold px-4 py-2 rounded-lg shadow-md transition-all duration-300 focus:ring-2 focus:ring-blue-500 flex items-center justify-center`}
                                >
                                    {isProcessingLike ? (
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`size-5 ${isLiked ? "fill-blue-500 stroke-blue-500" : "fill-none"}`}>
                                ...
                                <button onClick={toggleDislike} disabled={isButtonDisabled}
                                    className={`w-full sm:w-auto bg-indigo-900 ${isProcessingDislike ? "opacity-50 cursor-not-allowed" : "hover:bg-indigo-950"} text-white font-semibold px-4 py-2 rounded-lg shadow-md transition-all duration-300 focus:ring-2 focus:ring-blue-500 flex items-center justify-center`}
                                >
                                    {isProcessingDislike ? (
                                        <svg className="animate-spin size-5 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
