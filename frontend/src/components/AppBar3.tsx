...
export const AppBar3 = () => {
    ...
    return (
        <motion.nav
            className={`w-full fixed top-0 z-50 flex items-center justify-between px-6 py-3 transition-all duration-300
        ...
        >
            ...
            <div className="flex items-center cursor-pointer" onClick={scrollToTop}>
                ...
                />
                <span
                    className={`ml-1 text-xl font-bold tracking-wide ${isScrolled ? "text-indigo-400" : "bg-gradient-to-b from-blue-600/95 via-blue-200 to-white/90 bg-clip-text text-transparent"
            ...
            >
                {isScrolled ? <span>SIGN <span className="font-normal">IN</span></span> : <span>SIGN <span className="font-normal">UP</span></span>}
            </Link>
        </motion.nav>
    );
};
