...
export default function HeroSection({ blogSliderRef }: HeroSectionProps) {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen bg-[#0f172a] text-white overflow-hidden px-4">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
                ...
                >
                    <span className="text-indigo-400">{displayedText}</span>
                    <span className="text-white animate-pulse font-normal">|</span>
                </motion.h1>

                {/* Animated Subtext */}
                <p className="mt-3 md:mt-4 text-base md:text-lg text-gray-300 max-w-[90%] md:max-w-xl opacity-90 hover:opacity-100 transition-opacity duration-300">
